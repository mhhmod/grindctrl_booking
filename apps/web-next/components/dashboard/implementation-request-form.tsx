      ...
      <CardContent>
        <form
          ...
          onSubmit={(event) => {
            ...
            if (!companyName) nextErrors.push(c.companyRequired);
            if (!isValidEmail(workEmail)) nextErrors.push(c.emailInvalid);
            if (!businessType) nextErrors.push(c.businessTypeRequired);
            if (!primaryUseCase) nextErrors.push(c.useCaseRequired);
            if (!urgency) nextErrors.push(c.urgencyRequired);
            if (selectedChannels.length === 0) nextErrors.push(c.channelRequired);
            if (selectedTools.length === 0) nextErrors.push(c.toolRequired);
        ...
        >
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="businessType" name="businessType" required placeholder={c.businessTypePlaceholder} />
            </div>
            <div className="space-y-2">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <textarea id="pain" name="pain" className={textAreaClassName} placeholder={c.painPlaceholder} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="notes">{c.notes}</Label>
              <textarea id="notes" name="notes" className={textAreaClassName} placeholder={c.notesPlaceholder} />
            </div>
          </div>
