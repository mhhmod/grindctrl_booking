...
const COPY = {
  en: {
    ...
    greetingSection: 'First hello',
    greetingToggle: 'Show a small message bubble shortly after the page loads',
    greetingDelay: 'Wait this long first (seconds)',
    greetingText: 'What it says',
    greetingPh: 'Leave empty for the default hello',
    proactiveSection: 'Second reminder',
    proactiveToggle: 'Show one more bubble if the shopper still has not opened the chat',
    proactiveDelay: 'Wait this long first (seconds)',
    proactiveNote:
      'A single follow-up after the first hello, shown once per shopper and never again once they close it. Off unless you turn it on.',
  ...
  ar: {
    ...
    proactiveSection: 'تذكير ثانٍ',
    proactiveToggle: 'أظهر فقاعة أخرى إذا لم يفتح العميل الدردشة بعد',
    proactiveDelay: 'انتظر هذه المدة أولاً (ثوانٍ)',
    proactiveNote:
      'متابعة واحدة بعد الترحيب الأول، تظهر مرة لكل عميل ولا تتكرر بعد إغلاقها. معطّلة ما لم تفعّلها.',
