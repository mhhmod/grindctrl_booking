...
export function DeskProduct({ v, t }: ViewProps) {
  return (
    <>
      ...
      <div data-k="bblock" style={{ position: "absolute", insetInlineStart: "50%", top: "0", width: "1200px", marginInlineStart: "-600px", transformOrigin: "50% 0", transform: "translate3d(0, 96px, 0)" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <h2 id="product-title" style={{ margin: "14px 0 0", fontSize: "48px", lineHeight: "1.08", fontWeight: "700", letterSpacing: "calc(-0.035em * var(--gc-ls, 1))" }}>{t("One system, five connected parts")}</h2>
          <p style={{ margin: "12px auto 0", maxWidth: "640px", fontSize: "18px", lineHeight: "1.6", color: "var(--muted-foreground)" }}>{t("Watch each part work, shown with demo data. Where a part is not finished, it says so.")}</p>
        </div>
        <div style={{ marginTop: "30px", display: "grid", gridTemplateColumns: "380px minmax(0, 1fr)", gap: "40px", alignItems: "start" }}>
          <div role="group" aria-label={t("Parts of the system")} style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            <button type="button" onClick={v.pickTab0} aria-pressed={v.tab0On} style={{ position: "relative", overflow: "hidden", display: "block", width: "100%", boxSizing: "border-box", padding: "18px 22px", border: "0", borderRadius: "16px", background: v.tab0Bg, color: v.tab0Fg, textAlign: "start", cursor: "pointer", transition: "background-color 0.3s ease, color 0.3s ease" }}>
              <span style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" aria-hidden="true"><path d="M4 9.5l1.4-5h13.2l1.4 5M4 9.5h16M4 9.5v10h16v-10M9.5 19.5v-5h5v5" /></svg>
                <span style={{ flexGrow: "1", fontSize: "17px", fontWeight: "700" }}>{t("Storefront")}</span>
                {v.tab0On ? (
                  <>
                    <span style={{ display: "inline-flex", alignItems: "center", gap: "5px", height: "22px", padding: "0 8px", borderRadius: "26px", background: "color-mix(in srgb, var(--background) 12%, transparent)", color: "var(--background)", fontSize: "10.5px", fontWeight: "700" }}>
                      <span style={{ position: "relative", width: "5px", height: "5px", borderRadius: "50%", background: "var(--background)" }}>
                        <span aria-hidden="true" style={{ position: "absolute", inset: "0", borderRadius: "50%", background: "var(--background)", opacity: "0", animation: "gcs-ping 2.4s ease-out 0s infinite" }} />
                      </span>
                      {t("Live")}
                    </span>
                  </>
              ...
              {" "}
              <span style={{ display: "block", margin: "6px 0 0 32px", fontSize: "14px", lineHeight: "1.55", color: v.tab0Sub, transition: "color 0.3s ease" }}>{t("AI try-on on your product pages.")}</span>
              {" "}
              {v.tab0Bar ? (
                <>
                  <span aria-hidden="true" style={{ position: "absolute", insetInlineStart: "22px", insetInlineEnd: "22px", bottom: "8px", height: "2px", borderRadius: "2px", overflow: "hidden", background: "color-mix(in srgb, var(--background) 16%, transparent)" }}>
                    <span style={{ display: "block", height: "100%", background: "var(--background)", transformOrigin: "var(--gc-start) center", animation: `${v.progAnim} ${v.progDur} linear both` }} />
                  </span>
                </>
              ) : null}
            </button>
            <button type="button" onClick={v.pickTab1} aria-pressed={v.tab1On} style={{ position: "relative", overflow: "hidden", display: "block", width: "100%", boxSizing: "border-box", padding: "18px 22px", border: "0", borderRadius: "16px", background: v.tab1Bg, color: v.tab1Fg, textAlign: "start", cursor: "pointer", transition: "background-color 0.3s ease, color 0.3s ease" }}>
              <span style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <span style={{ flexGrow: "1", fontSize: "17px", fontWeight: "700" }}>{t("Conversation")}</span>
                {v.tab1On ? (
                  <>
                    <span style={{ display: "inline-flex", alignItems: "center", gap: "5px", height: "22px", padding: "0 8px", borderRadius: "26px", background: "color-mix(in srgb, var(--background) 12%, transparent)", color: "var(--background)", fontSize: "10.5px", fontWeight: "700" }}>
                      <span style={{ position: "relative", width: "5px", height: "5px", borderRadius: "50%", background: "var(--background)" }}>
              ...
              {" "}
              <span style={{ display: "block", margin: "6px 0 0 32px", fontSize: "14px", lineHeight: "1.55", color: v.tab1Sub, transition: "color 0.3s ease" }}>{t("Store Chat answers from your store knowledge and hands off when needed.")}</span>
              {" "}
              {v.tab1Bar ? (
                <>
                  <span aria-hidden="true" style={{ position: "absolute", insetInlineStart: "22px", insetInlineEnd: "22px", bottom: "8px", height: "2px", borderRadius: "2px", overflow: "hidden", background: "color-mix(in srgb, var(--background) 16%, transparent)" }}>
            ...
            <button type="button" onClick={v.pickTab2} aria-pressed={v.tab2On} style={{ position: "relative", overflow: "hidden", display: "block", width: "100%", boxSizing: "border-box", padding: "18px 22px", border: "0", borderRadius: "16px", background: v.tab2Bg, color: v.tab2Fg, textAlign: "start", cursor: "pointer", transition: "background-color 0.3s ease, color 0.3s ease" }}>
              <span style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <circle cx="12" cy="8" r="3.6" />
                  <path d="M4.8 20c.8-3.6 3.6-5.6 7.2-5.6s6.4 2 7.2 5.6" />
                </svg>
                <span style={{ flexGrow: "1", fontSize: "17px", fontWeight: "700" }}>{t("Customer")}</span>
                {v.tab2On ? (
                  <>
                    <span style={{ display: "inline-flex", alignItems: "center", gap: "5px", height: "22px", padding: "0 8px", borderRadius: "26px", background: "color-mix(in srgb, var(--background) 12%, transparent)", color: "var(--background)", fontSize: "10.5px", fontWeight: "700" }}>
                      <span style={{ position: "relative", width: "5px", height: "5px", borderRadius: "50%", background: "var(--background)" }}>
              ...
              {" "}
              <span style={{ display: "block", margin: "6px 0 0 32px", fontSize: "14px", lineHeight: "1.55", color: v.tab2Sub, transition: "color 0.3s ease" }}>{t("Name, email and the full thread stay together in your inbox. CRM sync is planned.")}</span>
              {" "}
              {v.tab2Bar ? (
                <>
                  <span aria-hidden="true" style={{ position: "absolute", insetInlineStart: "22px", insetInlineEnd: "22px", bottom: "8px", height: "2px", borderRadius: "2px", overflow: "hidden", background: "color-mix(in srgb, var(--background) 16%, transparent)" }}>
            ...
            <button type="button" onClick={v.pickTab3} aria-pressed={v.tab3On} style={{ position: "relative", overflow: "hidden", display: "block", width: "100%", boxSizing: "border-box", padding: "18px 22px", border: "0", borderRadius: "16px", background: v.tab3Bg, color: v.tab3Fg, textAlign: "start", cursor: "pointer", transition: "background-color 0.3s ease, color 0.3s ease" }}>
              <span style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <circle cx="6" cy="6" r="2.5" />
                  <circle cx="18" cy="18" r="2.5" />
                  <path d="M8.5 6H14a3 3 0 013 3v6.5" />
                </svg>
                <span style={{ flexGrow: "1", fontSize: "17px", fontWeight: "700" }}>{t("Workflow")}</span>
                {v.tab3On ? (
                  <>
                    <span style={{ display: "inline-flex", alignItems: "center", gap: "5px", height: "22px", padding: "0 8px", borderRadius: "26px", background: "color-mix(in srgb, var(--background) 12%, transparent)", color: "var(--background)", fontSize: "10.5px", fontWeight: "700" }}>
                      <span style={{ position: "relative", width: "5px", height: "5px", borderRadius: "50%", background: "var(--background)" }}>
              ...
              {" "}
              <span style={{ display: "block", margin: "6px 0 0 32px", fontSize: "14px", lineHeight: "1.55", color: v.tab3Sub, transition: "color 0.3s ease" }}>{t("The AI answers or hands off with the reason, your team gets an email, and every case lands in the dashboard.")}</span>
              {" "}
              {v.tab3Bar ? (
                <>
                  <span aria-hidden="true" style={{ position: "absolute", insetInlineStart: "22px", insetInlineEnd: "22px", bottom: "8px", height: "2px", borderRadius: "2px", overflow: "hidden", background: "color-mix(in srgb, var(--background) 16%, transparent)" }}>
            ...
            <button type="button" onClick={v.pickTab4} aria-pressed={v.tab4On} style={{ position: "relative", overflow: "hidden", display: "block", width: "100%", boxSizing: "border-box", padding: "18px 22px", border: "0", borderRadius: "16px", background: v.tab4Bg, color: v.tab4Fg, textAlign: "start", cursor: "pointer", transition: "background-color 0.3s ease, color 0.3s ease" }}>
              <span style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" aria-hidden="true"><path d="M4 20V10M10 20V4M16 20v-7M21 20H3" /></svg>
                <span style={{ flexGrow: "1", fontSize: "17px", fontWeight: "700" }}>{t("Report")}</span>
                {v.tab4On ? (
                  <>
                    <span style={{ display: "inline-flex", alignItems: "center", gap: "5px", height: "22px", padding: "0 8px", borderRadius: "26px", background: "color-mix(in srgb, var(--background) 12%, transparent)", color: "var(--background)", fontSize: "10.5px", fontWeight: "700" }}>
                      <span style={{ position: "relative", width: "5px", height: "5px", borderRadius: "50%", background: "var(--background)" }}>
              ...
              {" "}
              <span style={{ display: "block", margin: "6px 0 0 32px", fontSize: "14px", lineHeight: "1.55", color: v.tab4Sub, transition: "color 0.3s ease" }}>{t("Store Chat and try-on activity in your dashboard. Revenue attribution is planned.")}</span>
              {" "}
              {v.tab4Bar ? (
                <>
                  <span aria-hidden="true" style={{ position: "absolute", insetInlineStart: "22px", insetInlineEnd: "22px", bottom: "8px", height: "2px", borderRadius: "2px", overflow: "hidden", background: "color-mix(in srgb, var(--background) 16%, transparent)" }}>
          ...
          <div style={{ position: "relative", height: "540px", boxSizing: "border-box", borderRadius: "26px", overflow: "hidden", background: "var(--foreground)", color: "var(--background)" }}>
            <div aria-hidden="true" style={{ position: "absolute", inset: "0", background: "radial-gradient(60% 60% at 72% 40%, color-mix(in srgb, var(--background) 8%, transparent) 0%, transparent 70%)" }} />
            <div aria-hidden="true" style={{ position: "absolute", insetInlineStart: "380px", top: "-160px", width: "520px", height: "520px", borderRadius: "50%", background: "radial-gradient(closest-side, color-mix(in srgb, var(--background) 8%, transparent), transparent)", "--dx": "-90px", "--dy": "70px", animation: "gcs-drift 22s ease-in-out infinite" } as React.CSSProperties} />
            <div aria-hidden="true" style={{ position: "absolute", insetInlineStart: "-120px", top: "260px", width: "420px", height: "420px", borderRadius: "50%", background: "radial-gradient(closest-side, color-mix(in srgb, var(--background) 6%, transparent), transparent)", "--dx": "80px", "--dy": "-50px", animation: "gcs-drift 27s ease-in-out infinite" } as React.CSSProperties} />
            <div aria-hidden={v.pane0Hide} style={{ position: "absolute", inset: "0", boxSizing: "border-box", padding: "34px 40px 0", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px", opacity: v.pane0Op, transform: `translateY(${v.pane0Y})`, transition: "opacity 0.45s ease, transform 0.6s cubic-bezier(0.22, 1, 0.36, 1)", pointerEvents: v.pane0Pe }}>
              <div role="img" aria-label={t("Animated demo: on a product page a shopper taps Try it on with AI, adds her photo, generates a try-on preview of the shirt on herself and adds it to her cart.")} style={{ position: "relative", boxSizing: "border-box", borderRadius: "16px", background: "var(--card)", color: "var(--foreground)", overflow: "hidden", boxShadow: "0 0 0 1px color-mix(in srgb, var(--background) 12%, transparent), 0 30px 60px -30px color-mix(in srgb, var(--foreground) 85%, transparent)", textAlign: "start", width: "660px", height: "430px" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: "46px", padding: "0 20px", borderBottom: "1px solid var(--secondary)" }}>
                  <span style={{ fontSize: "11px", fontWeight: "800", letterSpacing: "calc(0.14em * var(--gc-ls, 1))" }}>{t("GRINDCTRL DEMO STORE")}</span>
                ...
                <div style={{ display: "flex", gap: "28px", padding: "22px 24px" }}>
                  <div style={{ width: "250px", height: "322px", flexShrink: "0", borderRadius: "12px", overflow: "hidden", background: "var(--card)" }}>
                    <StoryImg src="/landing/v15/garment-linen-shirt.webp" w={768} h={960} alt="" sizes="250px" style={{ width: "100%", height: "100%", objectFit: "contain", display: "block" }} />
                  </div>
                  <div style={{ display: "flex", flexDirection: "column", gap: "14px", minWidth: "0", flexGrow: "1" }}>
                    <span style={{ fontSize: "22px", fontWeight: "700", letterSpacing: "calc(-0.02em * var(--gc-ls, 1))", lineHeight: "1.2" }}>{t("Sage linen shirt")}</span>
                    <span style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                      <span style={{ fontSize: "11px", fontWeight: "600", color: "var(--gc-text-2)" }}>{t("Size")}</span>
                      <span style={{ display: "flex", gap: "5px" }}>
                        <span style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "38px", height: "34px", borderRadius: "8px", fontSize: "12px", fontWeight: "700", border: "1px solid var(--border)" }}>{t("S")}</span>
                        <span style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "38px", height: "34px", borderRadius: "8px", fontSize: "12px", fontWeight: "700", background: "var(--foreground)", color: "var(--background)" }}>{t("M")}</span>
                        <span style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "38px", height: "34px", borderRadius: "8px", fontSize: "12px", fontWeight: "700", border: "1px solid var(--border)" }}>{t("L")}</span>
                        <span style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "38px", height: "34px", borderRadius: "8px", fontSize: "12px", fontWeight: "700", border: "1px solid var(--border)" }}>{t("XL")}</span>
                      </span>
                    </span>
                    <span style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "7px", height: "44px", borderRadius: "22px", fontSize: "13px", fontWeight: "700", whiteSpace: "nowrap", background: "var(--foreground)", color: "var(--background)" }}>{t("Add to cart")}</span>
                    <span style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "7px", height: "44px", borderRadius: "22px", fontSize: "13px", fontWeight: "700", whiteSpace: "nowrap", border: "1px solid var(--foreground)", background: v.sfTryBg, transform: `scale(${v.sfTryS})`, transition: "background-color 0.25s ease, transform 0.2s ease" }}>
                ...
                <div style={{ position: "absolute", zIndex: "10", insetInlineStart: "290px", insetInlineEnd: "12px", top: "56px", bottom: "12px", boxSizing: "border-box", padding: "16px", borderRadius: "14px", border: "1px solid var(--border)", background: "var(--background)", boxShadow: "0 24px 50px -28px color-mix(in srgb, var(--foreground) 55%, transparent)", display: "flex", flexDirection: "column", gap: "10px", clipPath: v.sfClip, opacity: v.sfEmbedOp, transition: v.sfEmbedTr }}>
                  ...
                  <span style={{ fontSize: "15px", fontWeight: "700", letterSpacing: "calc(-0.01em * var(--gc-ls, 1))" }}>
                    {v.sfT1 ? (
                      <>
                        {t("Upload your photo")}
                      </>
                  ...
                  <div style={{ position: "relative", flexShrink: "0", height: "196px", boxSizing: "border-box", borderRadius: "12px", overflow: "hidden", background: "var(--card)", border: `1.5px dashed ${v.sfBoxLine}`, transition: "border-color 0.3s ease" }}>
                    <span style={{ position: "absolute", inset: "0", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "5px", padding: "0 14px", color: "var(--muted-foreground)", textAlign: "center" }}>
                      ...
                      <span style={{ fontSize: "12.5px", fontWeight: "700", color: "var(--foreground)" }}>{t("Drag and drop your photo here")}</span>
                      <span style={{ fontSize: "10.5px" }}>{t("or click to browse · JPG, PNG, WebP")}</span>
                    </span>
                    <StoryImg src="/landing/v15/shopper-woman.webp" w={768} h={960} alt="" sizes="660px" style={{ position: "absolute", inset: "0", width: "100%", height: "100%", objectFit: "cover", objectPosition: "50% 22%", display: "block", opacity: v.sfPhotoOp, transform: `scale(${v.sfPhotoS})`, transition: "opacity 0.4s ease, transform 0.5s cubic-bezier(0.22, 1, 0.36, 1)" }} />
                    <StoryImg src="/landing/v15/woman-linen-shirt.webp" w={922} h={1152} alt="" sizes="660px" style={{ position: "absolute", inset: "0", zIndex: "2", width: "100%", height: "100%", objectFit: "cover", objectPosition: "50% 22%", display: "block", clipPath: `inset(0 0 ${v.sfResClip} 0)`, transition: v.sfResTr }} />
                  ...
                  <div style={{ minHeight: "14px", fontSize: "10.5px", lineHeight: "1.4", color: "var(--muted-foreground)" }}>
                    {v.sfPriv ? (
                      <>
                  ...
                  <div style={{ marginTop: "auto" }}>
                    {v.sfBtnGen ? (
                      <>
                        <span style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "7px", height: "42px", borderRadius: "21px", background: "var(--foreground)", color: "var(--background)", fontSize: "12.5px", fontWeight: "700", whiteSpace: "nowrap", transition: "opacity 0.25s ease, transform 0.2s ease", opacity: v.sfGenOp, transform: `scale(${v.sfGenS})` }}>
                          <svg width="12" height="12" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M12 2.5c.7 4.9 3.6 7.8 8.5 8.5-4.9.7-7.8 3.6-8.5 8.5-.7-4.9-3.6-7.8-8.5-8.5 4.9-.7 7.8-3.6 8.5-8.5z" fill="var(--background)" />
                          </svg>
                    ...
                    {v.sfBtnCart ? (
                      <>
                        <span style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "7px", height: "42px", borderRadius: "21px", background: "var(--foreground)", color: "var(--background)", fontSize: "12.5px", fontWeight: "700", whiteSpace: "nowrap", transition: "opacity 0.25s ease, transform 0.2s ease", transform: `scale(${v.sfCartBtnS})`, animation: "gcs-in 0.4s cubic-bezier(0.22, 1, 0.36, 1) both" }}>
                          {v.sfAdding ? (
                            <>
                              {t("Adding…")}
                            </>
            ...
            <div aria-hidden={v.pane1Hide} style={{ position: "absolute", inset: "0", boxSizing: "border-box", padding: "34px 40px 0", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px", opacity: v.pane1Op, transform: `translateY(${v.pane1Y})`, transition: "opacity 0.45s ease, transform 0.6s cubic-bezier(0.22, 1, 0.36, 1)", pointerEvents: v.pane1Pe }}>
              <div role="img" aria-label={t("Animated demo: a shopper asks about sizing and the assistant answers from the store knowledge. She rates the answer, asks about stock, leaves her email for the reply, and the team joins with an answer.")} style={{ position: "relative", boxSizing: "border-box", borderRadius: "16px", background: "var(--card)", color: "var(--foreground)", overflow: "hidden", boxShadow: "0 0 0 1px color-mix(in srgb, var(--background) 12%, transparent), 0 30px 60px -30px color-mix(in srgb, var(--foreground) 85%, transparent)", textAlign: "start", width: "660px", height: "430px" }}>
                <div aria-hidden="true" style={{ position: "absolute", insetInlineStart: "0", top: "0", bottom: "0", width: "310px", padding: "22px 24px", boxSizing: "border-box", opacity: "0.5" }}>
                  <span style={{ display: "block", fontSize: "11px", fontWeight: "800", letterSpacing: "calc(0.14em * var(--gc-ls, 1))" }}>{t("GRINDCTRL DEMO STORE")}</span>
                  {" "}
                  <span style={{ display: "block", marginTop: "18px", width: "200px", height: "250px", borderRadius: "12px", overflow: "hidden", background: "var(--card)" }}>
                    <StoryImg src="/landing/v15/garment-linen-shirt.webp" w={768} h={960} alt="" sizes="200px" style={{ width: "100%", height: "100%", objectFit: "contain", display: "block" }} />
                  </span>
                  {" "}
                  <span style={{ display: "block", marginTop: "14px", fontSize: "18px", fontWeight: "700" }}>{t("Sage linen shirt")}</span>
                  {" "}
                  <span style={{ display: "block", marginTop: "10px", width: "200px", height: "38px", borderRadius: "19px", background: "var(--foreground)" }} />
                </div>
                <div style={{ position: "absolute", top: "0", insetInlineEnd: "0", bottom: "0", width: "350px", boxSizing: "border-box", display: "flex", flexDirection: "column", background: "var(--card)", borderInlineStart: "1px solid var(--border)" }}>
                  ...
                  <div style={{ flexGrow: "1", minHeight: "0", display: "flex", flexDirection: "column", justifyContent: "flex-end", gap: "8px", padding: "12px 14px", overflow: "hidden", fontSize: "12px", lineHeight: "1.45", WebkitMaskImage: "linear-gradient(180deg, transparent 0, var(--foreground) 30px)", maskImage: "linear-gradient(180deg, transparent 0, var(--foreground) 30px)" }}>
                    {v.cv1 ? (
                      <>
            ...
            <div aria-hidden={v.pane2Hide} style={{ position: "absolute", inset: "0", boxSizing: "border-box", padding: "34px 40px 0", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px", opacity: v.pane2Op, transform: `translateY(${v.pane2Y})`, transition: "opacity 0.45s ease, transform 0.6s cubic-bezier(0.22, 1, 0.36, 1)", pointerEvents: v.pane2Pe }}>
              <div role="img" aria-label={t("Animated demo: a new conversation from Salma arrives in the team inbox and opens with the whole thread, what the AI said and why it was handed off.")} style={{ position: "relative", boxSizing: "border-box", borderRadius: "16px", background: "var(--card)", color: "var(--foreground)", overflow: "hidden", boxShadow: "0 0 0 1px color-mix(in srgb, var(--background) 12%, transparent), 0 30px 60px -30px color-mix(in srgb, var(--foreground) 85%, transparent)", textAlign: "start", width: "660px", height: "430px" }}>
                <div style={{ position: "absolute", insetInlineStart: "0", top: "0", bottom: "0", width: "262px", boxSizing: "border-box", padding: "12px 10px", display: "flex", flexDirection: "column", gap: "7px", borderInlineEnd: "1px solid var(--secondary)" }}>
                  ...
                  <span style={{ marginTop: "auto", padding: "0 4px", fontSize: "10px", color: "var(--muted-foreground)" }}>{t("CRM sync is planned.")}</span>
                </div>
                <div style={{ position: "absolute", insetInlineStart: "262px", insetInlineEnd: "0", top: "0", bottom: "0", display: "flex", flexDirection: "column" }}>
                  {v.cuThA ? (
                    <>
                      <div style={{ display: "flex", flexDirection: "column", flexGrow: "1", minHeight: "0" }}>
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "8px", padding: "11px 14px", borderBottom: "1px solid var(--secondary)" }}>
                          <span style={{ display: "inline-flex", alignItems: "center", height: "20px", padding: "0 8px", borderRadius: "20px", border: "1px solid var(--border)", color: "var(--foreground)", fontSize: "10px", fontWeight: "700", whiteSpace: "nowrap" }}>{t("AI handling")}</span>
                          <span style={{ display: "flex", gap: "6px" }}>
                            <span style={{ display: "inline-flex", alignItems: "center", height: "28px", padding: "0 10px", borderRadius: "14px", border: "1px solid var(--border)", fontSize: "10.5px", fontWeight: "700" }}>{t("Take over")}</span>
                            <span style={{ display: "inline-flex", alignItems: "center", height: "28px", padding: "0 10px", fontSize: "10.5px", fontWeight: "700", color: "var(--gc-text-2)" }}>{t("Mark resolved")}</span>
                          </span>
                        </div>
                        <div style={{ flexGrow: "1", display: "flex", flexDirection: "column", justifyContent: "flex-end", gap: "7px", padding: "12px 14px", fontSize: "11.5px", lineHeight: "1.4" }}>
                          <div style={{ alignSelf: "flex-start", maxWidth: "84%", padding: "7px 11px", borderRadius: "14px", background: "var(--secondary)" }}>{t("Do you ship to Alexandria, and how long does it take?")}</div>
                        </div>
                      </div>
                    </>
                  ) : null}
                  {v.cuThS ? (
                    <>
                      <div style={{ display: "flex", flexDirection: "column", flexGrow: "1", minHeight: "0" }}>
                        <div style={{ display: "flex", flexDirection: "column", gap: "7px", padding: "10px 14px", borderBottom: "1px solid var(--secondary)" }}>
                          {v.cuHand ? (
                            <>
                        ...
                        <div style={{ flexGrow: "1", minHeight: "0", display: "flex", flexDirection: "column", justifyContent: "flex-end", gap: "7px", padding: "12px 14px", fontSize: "11.5px", lineHeight: "1.4", overflow: "hidden" }}>
            ...
            <div aria-hidden={v.pane3Hide} style={{ position: "absolute", inset: "0", boxSizing: "border-box", padding: "34px 40px 0", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px", opacity: v.pane3Op, transform: `translateY(${v.pane3Y})`, transition: "opacity 0.45s ease, transform 0.6s cubic-bezier(0.22, 1, 0.36, 1)", pointerEvents: v.pane3Pe }}>
              <div role="group" aria-label={t("How work moves between the AI and your team. Pick a case: a sizing question the AI answers, a stock question it hands to your team with an email alert, or a photo the AI reads and labels for your team. Each case ends in the dashboard.")} style={{ position: "relative", boxSizing: "border-box", borderRadius: "16px", background: "var(--card)", color: "var(--foreground)", overflow: "hidden", boxShadow: "0 0 0 1px color-mix(in srgb, var(--background) 12%, transparent), 0 30px 60px -30px color-mix(in srgb, var(--foreground) 85%, transparent)", textAlign: "start", width: "660px", height: "430px", display: "flex", flexDirection: "column" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "10px", padding: "12px 14px", borderBottom: "1px solid var(--secondary)" }}>
                  ...
                  <div role="group" aria-label={t("Pick a case")} style={{ display: "flex", gap: "6px" }}>
                    <button type="button" onClick={v.pickCase0} aria-pressed={v.wfC0On} style={{ height: "32px", padding: "0 13px", borderRadius: "16px", border: "1px solid var(--foreground)", background: v.wfC0Bg, color: v.wfC0Fg, fontSize: "11.5px", fontWeight: "700", cursor: "pointer", whiteSpace: "nowrap", transition: "background-color 0.25s ease, color 0.25s ease" }}>{t("Sizing question")}</button>
                    <button type="button" onClick={v.pickCase1} aria-pressed={v.wfC1On} style={{ height: "32px", padding: "0 13px", borderRadius: "16px", border: "1px solid var(--foreground)", background: v.wfC1Bg, color: v.wfC1Fg, fontSize: "11.5px", fontWeight: "700", cursor: "pointer", whiteSpace: "nowrap", transition: "background-color 0.25s ease, color 0.25s ease" }}>{t("Stock question")}</button>
                    <button type="button" onClick={v.pickCase2} aria-pressed={v.wfC2On} style={{ height: "32px", padding: "0 13px", borderRadius: "16px", border: "1px solid var(--foreground)", background: v.wfC2Bg, color: v.wfC2Fg, fontSize: "11.5px", fontWeight: "700", cursor: "pointer", whiteSpace: "nowrap", transition: "background-color 0.25s ease, color 0.25s ease" }}>{t("Photo of an order")}</button>
                  </div>
                </div>
                <div style={{ position: "relative", flexGrow: "1", minHeight: "0" }}>
                  <svg aria-hidden="true" width="660" height="314" viewBox="0 0 660 314" style={{ position: "absolute", insetInlineStart: "0", top: "0", overflow: "visible" }}>
                    <path d="M156 157 L174 157" fill="none" strokeWidth="1.6" style={{ stroke: v.wfE12Base, strokeDasharray: v.wfE12Dash, opacity: v.wfE12Op, transition: "stroke 0.35s ease, opacity 0.35s ease" }} />
                    <path d="M156 157 L174 157" pathLength="100" fill="none" strokeWidth="3.2" strokeLinecap="round" style={{ stroke: "var(--foreground)", strokeDasharray: "14 200", strokeDashoffset: "14", animation: `${v.wfE12Flow} 0.8s cubic-bezier(0.45, 0, 0.2, 1) both` }} />
                    <path d="M318 157 C334 157 328 51 344 51" fill="none" strokeWidth="1.6" style={{ stroke: v.wfE23Base, strokeDasharray: v.wfE23Dash, opacity: v.wfE23Op, transition: "stroke 0.35s ease, opacity 0.35s ease" }} />
                    <path d="M318 157 C334 157 328 51 344 51" pathLength="100" fill="none" strokeWidth="3.2" strokeLinecap="round" style={{ stroke: "var(--foreground)", strokeDasharray: "14 200", strokeDashoffset: "14", animation: `${v.wfE23Flow} 0.8s cubic-bezier(0.45, 0, 0.2, 1) both` }} />
                    <path d="M318 157 C334 157 328 263 344 263" fill="none" strokeWidth="1.6" style={{ stroke: v.wfE24Base, strokeDasharray: v.wfE24Dash, opacity: v.wfE24Op, transition: "stroke 0.35s ease, opacity 0.35s ease" }} />
                    <path d="M318 157 C334 157 328 263 344 263" pathLength="100" fill="none" strokeWidth="3.2" strokeLinecap="round" style={{ stroke: "var(--foreground)", strokeDasharray: "14 200", strokeDashoffset: "14", animation: `${v.wfE24Flow} 0.8s cubic-bezier(0.45, 0, 0.2, 1) both` }} />
                    <path d="M318 157 L506 157" fill="none" strokeWidth="1.6" style={{ stroke: v.wfE26Base, strokeDasharray: v.wfE26Dash, opacity: v.wfE26Op, transition: "stroke 0.35s ease, opacity 0.35s ease" }} />
                    <path d="M318 157 L506 157" pathLength="100" fill="none" strokeWidth="3.2" strokeLinecap="round" style={{ stroke: "var(--foreground)", strokeDasharray: "14 200", strokeDashoffset: "14", animation: `${v.wfE26Flow} 0.8s cubic-bezier(0.45, 0, 0.2, 1) both` }} />
                    <path d="M488 51 L506 51" fill="none" strokeWidth="1.6" style={{ stroke: v.wfE37Base, strokeDasharray: v.wfE37Dash, opacity: v.wfE37Op, transition: "stroke 0.35s ease, opacity 0.35s ease" }} />
                    <path d="M488 51 L506 51" pathLength="100" fill="none" strokeWidth="3.2" strokeLinecap="round" style={{ stroke: "var(--foreground)", strokeDasharray: "14 200", strokeDashoffset: "14", animation: `${v.wfE37Flow} 0.8s cubic-bezier(0.45, 0, 0.2, 1) both` }} />
                    <path d="M488 263 L506 263" fill="none" strokeWidth="1.6" style={{ stroke: v.wfE45Base, strokeDasharray: v.wfE45Dash, opacity: v.wfE45Op, transition: "stroke 0.35s ease, opacity 0.35s ease" }} />
                    <path d="M488 263 L506 263" pathLength="100" fill="none" strokeWidth="3.2" strokeLinecap="round" style={{ stroke: "var(--foreground)", strokeDasharray: "14 200", strokeDashoffset: "14", animation: `${v.wfE45Flow} 0.8s cubic-bezier(0.45, 0, 0.2, 1) both` }} />
                    <path d="M578 234 L578 186" fill="none" strokeWidth="1.6" style={{ stroke: v.wfE56Base, strokeDasharray: v.wfE56Dash, opacity: v.wfE56Op, transition: "stroke 0.35s ease, opacity 0.35s ease" }} />
                    <path d="M578 234 L578 186" pathLength="100" fill="none" strokeWidth="3.2" strokeLinecap="round" style={{ stroke: "var(--foreground)", strokeDasharray: "14 200", strokeDashoffset: "14", animation: `${v.wfE56Flow} 0.8s cubic-bezier(0.45, 0, 0.2, 1) both` }} />
                    <path d="M578 128 L578 80" fill="none" strokeWidth="1.6" style={{ stroke: v.wfE67Base, strokeDasharray: v.wfE67Dash, opacity: v.wfE67Op, transition: "stroke 0.35s ease, opacity 0.35s ease" }} />
                  ...
                  <div style={{ position: "absolute", insetInlineStart: "12px", top: "128px", width: "144px", height: "58px", boxSizing: "border-box", padding: "9px 11px", borderRadius: "14px", border: `1px solid ${v.wfN1Line}`, background: v.wfN1Bg, color: v.wfN1Fg, opacity: v.wfN1Op, boxShadow: v.wfN1Sh, transform: `scale(${v.wfN1S})`, transition: "background-color 0.22s ease, color 0.22s ease, border-color 0.22s ease, box-shadow 0.3s ease, transform 0.35s ease, opacity 0.35s ease", display: "flex", flexDirection: "column", justifyContent: "center", gap: "3px" }}>
                    <span style={{ display: "flex", alignItems: "center", gap: "5px", fontSize: "calc(10.5px + 1px * var(--gc-ls, 1))", fontWeight: "700", whiteSpace: "nowrap" }}>
                      ...
                      {v.wfN1Done ? (
                        <>
                          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" style={{ marginInlineStart: "auto", flexShrink: "0" }}><path d="M20 6L9 17l-5-5" /></svg>
                        </>
                      ) : null}
                    </span>
                  ...
                  <div style={{ position: "absolute", insetInlineStart: "506px", top: "22px", width: "144px", height: "58px", boxSizing: "border-box", padding: "9px 11px", borderRadius: "14px", border: `1px solid ${v.wfN7Line}`, background: v.wfN7Bg, color: v.wfN7Fg, opacity: v.wfN7Op, boxShadow: v.wfN7Sh, transform: `scale(${v.wfN7S})`, transition: "background-color 0.22s ease, color 0.22s ease, border-color 0.22s ease, box-shadow 0.3s ease, transform 0.35s ease, opacity 0.35s ease", display: "flex", flexDirection: "column", justifyContent: "center", gap: "3px" }}>
                    ...
                    <span style={{ fontSize: "10px", opacity: "0.8", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{v.wfN7Sub}</span>
                  </div>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", minHeight: "52px", boxSizing: "border-box", padding: "8px 16px", borderTop: "1px solid var(--secondary)" }}>
                  ...
                  {v.wfLA ? (
                    <>
                      <p style={{ margin: "0", minWidth: "0", fontSize: "12.5px", fontWeight: "600", lineHeight: "1.35", animation: "gcs-in 0.4s cubic-bezier(0.22, 1, 0.36, 1) both" }}>{v.wfLine}</p>
                    </>
                  ) : null}
                  {v.wfLB ? (
                    <>
            ...
            <div aria-hidden={v.pane4Hide} style={{ position: "absolute", inset: "0", boxSizing: "border-box", padding: "34px 40px 0", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px", opacity: v.pane4Op, transform: `translateY(${v.pane4Y})`, transition: "opacity 0.45s ease, transform 0.6s cubic-bezier(0.22, 1, 0.36, 1)", pointerEvents: v.pane4Pe }}>
              <div role="img" aria-label={t("Animated demo: the dashboard counts Store Chat conversations, AI-closed chats, handoffs, reply time and satisfaction, and try-on generations per day.")} style={{ position: "relative", boxSizing: "border-box", borderRadius: "16px", background: "var(--card)", color: "var(--foreground)", overflow: "hidden", boxShadow: "0 0 0 1px color-mix(in srgb, var(--background) 12%, transparent), 0 30px 60px -30px color-mix(in srgb, var(--foreground) 85%, transparent)", textAlign: "start", width: "660px", height: "430px", display: "flex", flexDirection: "column", gap: "12px", padding: "18px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "row", gap: "12px", flexGrow: "1", minHeight: "0" }}>
                  <div style={{ display: "flex", flexDirection: "column", boxSizing: "border-box", borderRadius: "14px", border: "1px solid var(--border)", background: "var(--background)", gap: "14px", padding: "14px", flex: "1 1 0", minWidth: "0" }}>
                    ...
                    <span style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: "14px 12px" }}>
                      <span style={{ display: "flex", flexDirection: "column", gap: "3px" }}>
                        <span style={{ fontSize: "10.5px", color: "var(--muted-foreground)", lineHeight: "1.3" }}>{t("Conversations · 7 days")}</span>
                        <span style={{ fontSize: "28px", fontWeight: "700", letterSpacing: "calc(-0.02em * var(--gc-ls, 1))", lineHeight: "1.1", fontVariantNumeric: "tabular-nums" }}>{v.rpConv}</span>
                      </span>
                      <span style={{ display: "flex", flexDirection: "column", gap: "3px" }}>
                        <span style={{ fontSize: "10.5px", color: "var(--muted-foreground)", lineHeight: "1.3" }}>{t("Closed by AI")}</span>
                        <span style={{ fontSize: "28px", fontWeight: "700", letterSpacing: "calc(-0.02em * var(--gc-ls, 1))", lineHeight: "1.1", fontVariantNumeric: "tabular-nums" }}>{v.rpAi}</span>
                      </span>
                      <span style={{ display: "flex", flexDirection: "column", gap: "3px" }}>
                        <span style={{ fontSize: "10.5px", color: "var(--muted-foreground)", lineHeight: "1.3" }}>{t("Needed your team")}</span>
                        <span style={{ fontSize: "28px", fontWeight: "700", letterSpacing: "calc(-0.02em * var(--gc-ls, 1))", lineHeight: "1.1", fontVariantNumeric: "tabular-nums" }}>{v.rpTeam}</span>
                      </span>
                      <span style={{ display: "flex", flexDirection: "column", gap: "3px" }}>
                        <span style={{ fontSize: "10.5px", color: "var(--muted-foreground)", lineHeight: "1.3" }}>{t("Open right now")}</span>
                        <span style={{ fontSize: "28px", fontWeight: "700", letterSpacing: "calc(-0.02em * var(--gc-ls, 1))", lineHeight: "1.1", fontVariantNumeric: "tabular-nums" }}>{v.rpOpen}</span>
                      </span>
                    </span>
                    <span style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                      ...
                      <span style={{ display: "flex", justifyContent: "space-between", fontSize: "10px", color: "var(--muted-foreground)" }}>
                        <span>{t("Closed by AI")}</span>
                        <span>{t("Needed your team")}</span>
                      </span>
                    </span>
                    <span style={{ display: "flex", gap: "10px", marginTop: "auto", paddingTop: "12px", borderTop: "1px solid var(--secondary)" }}>
                      <span style={{ display: "flex", flexDirection: "column", gap: "2px", minWidth: "0", flex: "1 1 0" }}>
                        <span style={{ fontSize: "18px", fontWeight: "700", letterSpacing: "calc(-0.02em * var(--gc-ls, 1))", lineHeight: "1.1", fontVariantNumeric: "tabular-nums" }}>{v.rpReply}</span>
                        <span style={{ fontSize: "10.5px", color: "var(--muted-foreground)", lineHeight: "1.3" }}>{t("Median first reply (7d)")}</span>
                      </span>
                      <span style={{ display: "flex", flexDirection: "column", gap: "2px", minWidth: "0", flex: "1 1 0" }}>
                        <span style={{ fontSize: "18px", fontWeight: "700", letterSpacing: "calc(-0.02em * var(--gc-ls, 1))", lineHeight: "1.1", fontVariantNumeric: "tabular-nums" }}>{v.rpSat}</span>
                        <span style={{ fontSize: "10.5px", color: "var(--muted-foreground)", lineHeight: "1.3" }}>{t("Satisfaction · 30 days")}</span>
                      </span>
                    </span>
                  </div>
                  <div style={{ display: "flex", flexDirection: "column", boxSizing: "border-box", borderRadius: "14px", border: "1px solid var(--border)", background: "var(--background)", gap: "9px", padding: "14px 14px", flex: "1 1 0", minWidth: "0" }}>
                    <span style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <span style={{ display: "flex", gap: "14px" }}>
                      <span style={{ display: "flex", flexDirection: "column", gap: "2px", flex: "1 1 0" }}>
                        <span style={{ fontSize: "10.5px", color: "var(--muted-foreground)", lineHeight: "1.3" }}>{t("Generations, 7 days")}</span>
                        <span style={{ fontSize: "32px", fontWeight: "700", letterSpacing: "calc(-0.02em * var(--gc-ls, 1))", lineHeight: "1.1", fontVariantNumeric: "tabular-nums" }}>{v.rpGen}</span>
                        <span style={{ fontSize: "10px", color: "var(--muted-foreground)" }}>{t("up 25% on last week")}</span>
                      </span>
                      <span style={{ display: "flex", flexDirection: "column", gap: "2px", flex: "1 1 0" }}>
                        <span style={{ fontSize: "10.5px", color: "var(--muted-foreground)", lineHeight: "1.3" }}>{t("Success rate, 7 days")}</span>
                        <span style={{ fontSize: "32px", fontWeight: "700", letterSpacing: "calc(-0.02em * var(--gc-ls, 1))", lineHeight: "1.1", fontVariantNumeric: "tabular-nums" }}>{v.rpRate}</span>
                    ...
                    <span style={{ display: "flex", flexDirection: "column", gap: "5px", marginTop: "auto" }}>
                      <span style={{ fontSize: "10.5px", color: "var(--muted-foreground)", lineHeight: "1.3" }}>{t("Generations per day")}</span>
                      <span style={{ display: "flex", alignItems: "flex-end", gap: "9px", height: "118px", paddingTop: "22px" }}>
        ...
        <p style={{ margin: "14px 0 0", textAlign: "end", fontSize: "13px", color: "var(--muted-foreground)" }}>{t("Animated walkthroughs recreated from the product's own screens, with demo data.")}</p>
      </div>
    </>
  );
}
