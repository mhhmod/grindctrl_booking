...
export function PhoneResults({ v, t }: ViewProps) {
  return (
    <>
      ...
      <div data-k="chead" style={{ position: "absolute", insetInlineStart: "20px", insetInlineEnd: "20px", top: "0", textAlign: "center", transform: "translate3d(0, 80px, 0)" }}>
      ...
      <div data-k="counter" aria-hidden="true" style={{ position: "absolute", insetInlineStart: "0", insetInlineEnd: "0", top: "0", display: "flex", alignItems: "center", justifyContent: "center", gap: "14px", transform: "translate3d(0, 250px, 0)", fontSize: "12.5px", fontWeight: "700", fontVariantNumeric: "tabular-nums", color: "var(--foreground)" }}>
        <span>{v.resNum}</span>
        <span style={{ position: "relative", display: "block", width: "110px", height: "2px", borderRadius: "2px", overflow: "hidden", background: "color-mix(in srgb, var(--foreground) 14%, transparent)" }}>
