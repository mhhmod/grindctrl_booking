...
# Prompt 11 — Analytics and Review Metrics

## Objective

Add /dashboard/analytics showing what GrindCTRL will measure across trials, conversations, leads, and agents.

## UI source requirements

Use:
- Kiranism analytics/Recharts overview patterns.
- Shadboard dashboard analytics cards.
- Creembase analytics/admin blocks if available.
...
Use preview/sample labels unless data is real.
...
Use existing Recharts if already available.

## Likely files

apps/web-next/app/dashboard/analytics/page.tsx
apps/web-next/components/dashboard/analytics-preview.tsx
apps/web-next/lib/dashboard/analytics-preview-data.ts

## Tests

analytics page renders
metric cards render
chart/table fallback renders

## Output

Files changed
Analytics sections
Sample/preview wording
