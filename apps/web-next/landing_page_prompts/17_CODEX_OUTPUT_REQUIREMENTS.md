# Codex Output Requirements for UI Source Compliance

Every Codex/Claude run that changes UI must include this output block.

## Required output block

```txt
UI Source Compliance:
- Source repo/page/component used:
- What was copied/adapted:
- What was intentionally not copied:
- Dependencies added:
- Why a custom component was not built from scratch:
```
...
- No Clerk config changes:
- No root Vite app changes:
- No GitHub Actions changes:
- No secrets exposed:
- No real external actions claimed:
```
