...
const FALLBACK_CATALOG: PublicEntitlementCatalog = {
  plans: [
    ...
    },
    {
      planKey: 'growth-v1',
      name: 'Growth',
      description: 'More monthly renders for stores building momentum.',
      priceMinor: 2900,
      currency: 'USD',
      rendersIncluded: 350,
      modelKey: 'muse',
    ...
    },
    {
      planKey: 'pro-v1',
      name: 'Pro',
      description: 'High-volume renders plus hands-on setup and support.',
      priceMinor: 4900,
      currency: 'USD',
      rendersIncluded: 650,
      modelKey: 'muse',
