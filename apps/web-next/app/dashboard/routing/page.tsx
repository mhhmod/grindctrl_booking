...
export default async function DashboardRoutingPage({ searchParams }: Props) {
  ...
  if (!site) {
    return <div className="rounded-3xl border border-dashed border-zinc-700 bg-zinc-900 p-6 text-sm text-zinc-400">No widget site is available for routing yet.</div>;
  }
