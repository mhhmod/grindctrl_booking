(function () {
  ...
  function buildStandaloneHTML() {
    ...
    return [
      ...
      '<title>' + escapeHTML(state.result.agent_name) + '</title>',
      '<style>',
      'body{font-family:Inter,system-ui,sans-serif;background:#f4efe9;color:#1d1a18;margin:0;padding:32px;}',
      '.sheet{max-width:900px;margin:0 auto;background:#fff;border:1px solid rgba(24,24,22,.08);border-radius:24px;padding:32px;box-shadow:0 24px 64px rgba(24,24,22,.08)}',
      '.kicker{display:inline-flex;padding:8px 12px;border-radius:999px;background:#f1ebe4;color:#4f4a45;font-size:11px;font-weight:700;letter-spacing:.16em;text-transform:uppercase}',
      'h1{font-family:Manrope,system-ui,sans-serif;font-size:34px;line-height:1.05;margin:16px 0 10px}',
      'p,li{line-height:1.7;font-size:15px;color:#2f2b28}',
      '.grid{display:grid;gap:16px;margin-top:22px}',
      '.card{padding:18px;border-radius:18px;border:1px solid rgba(24,24,22,.08);background:#fbf8f4}',
      'h2{font-size:13px;letter-spacing:.08em;text-transform:uppercase;margin:0 0 10px}',
      'ol,ul{margin:0;padding-inline-start:20px}',
      '.bp-studio-preview-head{display:flex;justify-content:space-between;gap:16px;padding-bottom:18px;border-bottom:1px solid rgba(24,24,22,.08)}',
      '.bp-studio-preview-head h3{font-family:Manrope,system-ui,sans-serif;font-size:32px;line-height:1.08;margin:14px 0 10px;color:#181816}',
      '.bp-studio-preview-grid{display:grid;gap:16px;margin-top:22px}',
      '.bp-studio-preview-card{padding:18px;border-radius:18px;border:1px solid rgba(24,24,22,.08);background:#fbf8f4}',
      '.bp-studio-preview-card h4{font-size:13px;letter-spacing:.08em;text-transform:uppercase;margin:0 0 10px;color:#181816}',
      '.bp-studio-preview-list{display:grid;gap:10px}',
      '.bp-studio-preview-meta{display:grid;gap:6px;text-align:end;font-size:13px}',
      '.bp-studio-kicker{display:inline-flex;padding:8px 12px;border-radius:999px;background:#f1ebe4;color:#4f4a45;font-size:11px;font-weight:700;letter-spacing:.16em;text-transform:uppercase}',
      '@media (max-width:760px){body{padding:14px}.sheet{padding:18px;border-radius:18px}.bp-studio-preview-head{display:block}.bp-studio-preview-meta{text-align:start;margin-top:14px}}',
      '</style>',
      '</head>',
      '<body><div class="sheet">' + buildPreviewHTML(state.result) + '</div></body>',
      '</html>'
    ].join('');
  }
